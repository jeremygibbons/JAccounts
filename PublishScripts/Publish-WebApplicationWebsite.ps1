...
function New-WebDeployPackage
{
    ...
    #Pour générer votre application web, utilisez MsBuild.exe. Pour obtenir de l'aide, voir les informations de référence relatives à la syntaxe de ligne de commande de MSBuild à l'adresse suivante : http://go.microsoft.com/fwlink/?LinkId=391339
}
...
function Test-WebApplication
{
    ...
    #Pour écrire une fonction permettant d'exécuter des tests unitaires sur votre application web, utilisez VSTest.Console.exe. Pour obtenir de l'aide, voir les informations de référence relatives à la syntaxe de ligne de commande de VSTest.Console à l'adresse suivante : http://go.microsoft.com/fwlink/?LinkId=391340
}
